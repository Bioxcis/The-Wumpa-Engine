...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["Dance Comigo, Friday Night!", "Jogue em uma Sexta... a Noite.",					'friday_night_play',	 true],
		...
		["Crash Rei!",			    	"Complete uma musica com score de 100%.",			'ur_good',				false],
		...
		["Um Bonus Joia",				"Consiga a Gema da rodada Bonus",					'bonus',				false],
		["Lugar Toxico",				"Consiga um Cristal nos Esgotos da Ilha Industrial",'toxico',				false],
		["Perfectus Flora",				"Um movimento insanamente perfeito!",				'music1',				false],
		["Perfectus Bonus",				"Um movimento insanamente perfeito!",				'music2',				false],
		["Perfectus Tenebris",			"Um movimento insanamente perfeito!",				'music3',				false],
		["Perfectus Ardens",			"Um movimento insanamente perfeito!",				'music4',				false],
